...
def test_goaltree_selection_may_be_changed_in_switchable_view():
    ...
    assert e.q(keys="name,switchable,select") == {
        1: {"name": "Switchable 1", "switchable": True, "select": "select"},
        2: {"name": "Switchable 2", "switchable": True, "select": None},
    }
